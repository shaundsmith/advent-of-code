...
import dev.shaundsmith.adventofcode.aoc2025.day1.Day1
...
class Day1Test {
    ...
    @Test fun day1Part1() {
        ...
        val contents = fileLoader.loadFile("aoc2025/day1/test-input-1.txt")
    ...
    @Test fun day1Part2() {
        ...
        val contents = fileLoader.loadFile("aoc2025/day1/test-input-2.txt")
